...
//공휴일 배열(음력)
$holyday_moon = array(
	LunarToSola(($year - 1)."1230")=>"설 연휴",
	LunarToSola($year."0101")=>"설 연휴",
	LunarToSola($year."0102")=>"설 연휴",
	LunarToSola($year."0408")=>"석가탄신일",
	LunarToSola($year."0814")=>"추석 연휴",
	LunarToSola($year."0815")=>"추석 연휴",
	LunarToSola($year."0816")=>"추석 연휴"
);
